...
$breadcrumb = [['label'=>'Reseller'],['label'=>'Profile']];
...
<div class="card" style="max-width:800px">
  ...
  <form method="POST" action="/reseller/actions/update-profile.php">
    ...
    <div class="card-body">
      ...
      <div style="margin-top:24px;padding-top:20px;border-top:1px solid var(--border)">
        ...
        <div class="form-group"><label class="form-label">Current Password <span class="required">*</span></label><input type="password" name="current_password" class="form-control" placeholder="Required to save any changes" required></div>
        <div class="form-row">
