...
if (!$sessionId) die('<div class="alert alert-danger">Invalid Session</div>');
...
if (!$session) die('<div class="alert alert-danger">Session not found or access denied.</div>');
        ...
        <?php foreach ($requests as $r): ?>
            <div class="timeline-item">
                ...
                <div style="display:flex; justify-content:space-between; align-items:center">
                    ...
                    <span style="font-size:10px; color:var(--text-muted)"><?= $r['response_time'] ?>ms</span>
                </div>
                
                <div style="margin-top:8px">
                    <div class="msg-label">User Input</div>
                    <div class="msg-bubble" style="background:#fff">
                        <?= $r['input_text'] ? htmlspecialchars($r['input_text']) : '<i>(Empty/Start)</i>' ?>
                    </div>
                </div>
