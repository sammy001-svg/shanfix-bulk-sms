...
<div style="display:grid; grid-template-columns: 1fr 1fr; gap:30px">
    ...
    document.querySelector('form').addEventListener('submit', async function(e) {
        // Only intercept if we're doing the initiate_topup
        ...
        try {
            ...
            if (data.success) {
                if (data.manual) {
                    Swal.fire('Request Sent', 'Top-up request sent to your reseller. Please complete payment and wait for approval.', 'info');
                } else {
            ...
            btn.disabled = false;
            btn.innerHTML = '<i class="fa-solid fa-bolt"></i> Initiate Instant Top-up';
        }
    });
    </script>
