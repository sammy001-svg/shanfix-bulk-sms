...
<div class="page-header">
  ...
  <a href="/client/ussd-request.php" class="btn btn-primary"><i class="fa-solid fa-plus"></i> New Request</a>
</div>
    ...
    <div class="card-body" style="padding:0">
        <div class="table-wrapper">
            <table class="data-table">
                ...
                <tbody>
                    <?php if (empty($codes)): ?>
                        <tr><td colspan="6" class="text-center" style="padding:40px; color:var(--text-muted)">No USSD codes found. <a href="/client/ussd-request.php">Submit your first request here!</a></td></tr>
                    <?php endif; ?>
                        ...
                        <tr>
                            ...
                            <td style="text-align:right">
                                <div style="display:flex; gap:8px; justify-content:flex-end">
                                    <?php if ($c['status'] === 'approved'): ?>
                                        <a href="/client/ussd-sessions.php?code=<?= $c['id'] ?>" class="btn btn-sm btn-outline" title="View Sessions"><i class="fa-solid fa-history"></i></a>
                                        <a href="/client/ussd-analytics.php?code=<?= $c['id'] ?>" class="btn btn-sm btn-outline" title="Analytics"><i class="fa-solid fa-chart-line"></i></a>
                                    <?php endif; ?>
