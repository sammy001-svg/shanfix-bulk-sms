...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (!csrf_verify()) {
        ...
        redirect('/client/ussd-request.php');
    }
    ...
    if (empty($purpose)) {
        ...
        redirect('/client/ussd-codes.php');
    }
}
...
<div class="row">
    ...
    <div class="col-md-6">
        <div class="card">
            <div class="card-header"><div class="card-title"><i class="fa-solid fa-lightbulb"></i> USSD Information</div></div>
            <div class="card-body">
                <div class="mb-24">
                    <h5 class="mb-8" style="color:var(--primary)">What is Shared USSD?</h5>
                    <p class="text-secondary" style="font-size:14px">Shared USSD codes allow multiple businesses to share a single root code. You are assigned a unique sub-extension (e.g., *384*123#). This is cost-effective and fast to deploy.</p>
                </div>
                <div class="mb-24">
                    <h5 class="mb-8" style="color:var(--primary)">What is Dedicated USSD?</h5>
                    <p class="text-secondary" style="font-size:14px">A dedicated USSD code is exclusive to your brand (e.g., *123#). It provides a more premium user experience and is easier for customers to remember.</p>
                </div>
                <div class="mb-0">
                    <h5 class="mb-8" style="color:var(--primary)">Personalization</h5>
                    <p class="text-secondary" style="font-size:14px">Once approved, you can integrate your USSD code with your backend applications via our USSD API callbacks.</p>
                </div>
            </div>
        </div>
    </div>
