              ...
              <tr>
                ...
                <td>
                  <?php if ($c['status']==='draft' || $c['status']==='scheduled'): ?>
                    <button class="btn btn-primary btn-sm btn-icon" onclick='editCampaign(<?= htmlspecialchars(json_encode($c), ENT_QUOTES, 'UTF-8') ?>)' title="Edit/Send"><i class="fa-solid fa-paper-plane"></i></button>
