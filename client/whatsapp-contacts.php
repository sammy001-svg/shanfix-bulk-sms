...
<div style="display:grid; grid-template-columns: 240px 1fr; gap:24px; align-items:start">
  ...
  <div class="card">
    ...
    <div class="card-body" style="padding:8px 0">
      <a href="/client/whatsapp-contacts.php" class="nav-link <?= $groupId === 0 ? 'active' : '' ?>" style="padding:10px 20px; color:var(--text-primary)">
...
<div id="addContactModal" class="modal-overlay">
  <div class="modal">
    ...
    <form action="/client/actions/whatsapp-actions.php?action=add_contact" method="POST">
...
<div id="editContactModal" class="modal-overlay">
  <div class="modal">
    ...
    <form action="/client/actions/whatsapp-actions.php?action=edit_contact" method="POST">
        <div class="modal-body">
            <input type="hidden" name="csrf_token" value="<?= csrf_token() ?>">
...
<div id="addGroupModal" class="modal-overlay">
  <div class="modal">
    ...
    <form action="/client/actions/whatsapp-actions.php?action=add_group" method="POST">
        <div class="modal-body">
            <input type="hidden" name="csrf_token" value="<?= csrf_token() ?>">
...
<div id="importModal" class="modal-overlay">
  <div class="modal" style="max-width:600px">
    ...
    <form action="/client/actions/whatsapp-actions.php?action=import_contacts" method="POST" id="importForm">
        <div class="modal-body">
            <input type="hidden" name="csrf_token" value="<?= csrf_token() ?>">
...
function deleteContact(id) {
    if (confirm('Are you sure you want to delete this contact?')) {
        ...
        form.method = 'POST';
        form.action = '/client/actions/whatsapp-actions.php?action=delete_contact';
...
function deleteGroup(id, name) {
    if (confirm(`Are you sure you want to delete the group "${name}"? Contacts within this group will remain but will be uncategorized.`)) {
        window.location.href = `/client/actions/whatsapp-actions.php?action=delete_group&id=${id}&csrf_token=<?= csrf_token() ?>`;
    }
}
