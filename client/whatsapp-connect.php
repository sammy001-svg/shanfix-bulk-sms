            ...
            <div style="margin-top:20px; padding-top:20px; border-top:1px dashed var(--border)">
                ...
                <div id="ai_settings_fields" style="display:none">
                    ...
                    <div class="form-group mb-16">
                        ...
                        <textarea name="ai_prompt" id="acc_ai_prompt" class="form-control" rows="3" placeholder="e.g. You are a professional customer support for Shanfix Technology. We provide web hosting and bulk SMS services."></textarea>
                        <small class="text-muted">Describe your business so the AI can answer accurately.</small>
                    </div>
                </div>
            </div>
            
            <div class="alert alert-info mt-20" style="font-size:11px">
                <i class="fa-solid fa-info-circle"></i> Ensure your instance is active and the number is linked via QR code in your provider's dashboard.
            </div>
        </div>
